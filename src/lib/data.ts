export const projects = [
    ...
    },
    {
        ...
        title: "Business Process Improvement: Real-Time Translation",
        description: [
...
export const experiences = [
    {
        period: "May 1, 2022 -<br/>Oct 31, 2022",
        company: "Quicklly",
        role: "Customer Retention & Experience Program",
        description: [
    ...
    {
        period: "Nov 1, 2022 -<br/>Feb 29, 2024",
        company: "Quicklly",
        role: "B2B Operations & Revenue Management (NYC)",
        description: [
    ...
    },
    {
        ...
        company: "Quicklly",
        role: "Event Ticket Selling Business Launch",
        description: [
    ...
    {
        period: "Oct 1, 2021 -<br/>Mar 31, 2022",
    ...
    {
        period: "Jul 1, 2019 -<br/>Jun 30, 2020",
    ...
    {
        period: "Oct 1, 2020 -<br/>Dec 31, 2020",
        company: "MarketGad",
    ...
    {
        period: "Jul 1, 2020 -<br/>Sep 30, 2020",
        company: "IIFL Securities",
        role: "Branding and Finance Intern",
        description: [
...
export const certifications = [
    ...
    {
        title: "Google ADK Agent Development & GCP Exploration (Ongoing)",
        description: [
